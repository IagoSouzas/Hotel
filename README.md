# Hotel
<h3>  Desenvolvi um programa feito com vários outros programas utilizando um conceito de software modulado, feito com partes independentes.  O objetivo é desenvolver uma plataforma para funcionários do hotel usarem, não os hóspedes. </h3>

<h2> Para conseguir utilizar o programa a Senha é (2678) </h2>

<h4> Agora vamos para a parte que interessa! </h4>

<h3> 1) Quantos quartos são?
Todo hotel precisava reservar quartos. 
Então vamos começar por isso. </h3>

<p> Desenvolva um programa que: 
...
3) O próximo passo é perguntar se o usuário confirma a reserva. Caso não aceite, volte ao menu inicial. </p>
...
<h3> 4) Festa ou trabalho? </h3>

<p> Neste cenário, o hotel receberá não hóspedes, mas eventos. 
...
Por último, pergunte se o usuário aceita os valores. Se "S", exiba a mensagem "Reserva efetuada com sucesso". Caso contrário, exiba a mensagem "Reserva não efetuada." <p/>

<hr>

<h3> 5) Hora de comer </h3>

<p> Neste cenário vamos tratar do Buffet do hotel.
...
Por último, pergunte se o usuário aceita os valores. Se "SIM", exiba a mensagem "Reserva efetuada com sucesso". Caso contrário, exiba a mensagem "Reserva não efetuada." <p>

<hr>

<h3> 6) Auditório para quantos? </h3>

<p> O hotel necessita de uma funcionalidade que indique qual de seus dois auditórios é o mais adequado para um evento.
...
<h3> 7) Que horas você pode? </h3>

<p> Ainda em relação aos eventos, o hotel oferece reserva de seu restaurante caso o contratante necessite. O restaurante está disponível para reservas de segunda a sexta das 7hs às 23hs; sábados e domingos apenas das 7hs às 15hs. 
...
4) Quando o restaurante estiver disponível, receba ainda o nome da empresa e mostre na tela a mensagem “Restaurante reservado para (nome da empresa): (dia da semana) às (horas)hs”. </p>

<hr>

<h3> 8) Álcool ou gasolina? </h3>
...
Dica: Regra de três. </p>

<hr>

<h3> 9) Ar puro, finalmente. </h3>

<p> A manutenção dos ares condicionados no hotel é realizada por empresas terceirizadas que, em alguns casos, oferecem desconto quando o serviço é realizado em uma quantidade determinada de aparelhos. 
